...
use App\Repository\Core\Buildings\LogicalBuildingStockRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=LogicalBuildingStockRepository::class)
 */
class LogicalBuildingStock
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=LogicalBuilding::class, inversedBy="logicalBuildingStocks")
     * @ORM\JoinColumn(nullable=false)
     */
